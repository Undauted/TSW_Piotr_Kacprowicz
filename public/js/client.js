...
var socket      = null;
  ...
  var showGameOverMessage = function(type) {
    ...
    switch (type) {
      ...
      case 'checkmate-lose' : header.addClass('alert-danger').text('Szach-mat'); break;
      case 'forfeit-win'    : header.addClass('alert-success').text('Twój przeciwnik opuścił grę'); break;
      case 'forfeit-lose'   : header.addClass('alert-danger').text('Opuszczasz grę'); break;
      case 'stalemate'      : header.addClass('alert-warning').text('Sytuacja bez wyjścia'); break;
    }
